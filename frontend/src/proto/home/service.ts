...
export interface Device {
    ...
    modelVersion: string;
    /**
     * @generated from protobuf field: remote_control.home.DeviceStatus status = 14
     */
    status: DeviceStatus;
}
/**
...
export interface ListDevicesRequest {
    ...
    /**
     * @generated from protobuf field: bool include_pending = 6
     */
...
/**
 * @generated from protobuf message remote_control.home.ReserveDeviceRequest
 */
export interface ReserveDeviceRequest {
    /**
     * @generated from protobuf field: string model_id = 1
     */
    modelId: string;
    /**
     * @generated from protobuf field: string model_version = 2
     */
    modelVersion: string;
}
/**
 * @generated from protobuf message remote_control.home.ReserveDeviceResponse
 */
export interface ReserveDeviceResponse {
    /**
     * @generated from protobuf field: bool ok = 1
     */
    ok: boolean;
...
/**
 * @generated from protobuf enum remote_control.home.DeviceStatus
 */
export enum DeviceStatus {
    /**
     * @generated from protobuf enum value: DEVICE_STATUS_UNSPECIFIED = 0;
     */
    UNSPECIFIED = 0,
    /**
     * @generated from protobuf enum value: DEVICE_STATUS_ACTIVE = 1;
     */
    ACTIVE = 1,
    /**
     * @generated from protobuf enum value: DEVICE_STATUS_PENDING = 2;
     */
    PENDING = 2
}
/**
...
class Device$Type extends MessageType<Device> {
    constructor() {
        super("remote_control.home.Device", [
            ...
            { no: 14, name: "status", kind: "enum", T: () => ["remote_control.home.DeviceStatus", DeviceStatus, "DEVICE_STATUS_"] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string model_version */ 13:
                    ...
                    break;
                case /* remote_control.home.DeviceStatus status */ 14:
    ...
    internalBinaryWrite(message: Device, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* remote_control.home.DeviceStatus status = 14; */
        if (message.status !== 0)
...
class ListDevicesRequest$Type extends MessageType<ListDevicesRequest> {
    constructor() {
        super("remote_control.home.ListDevicesRequest", [
            ...
            { no: 6, name: "include_pending", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: ListDevicesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* bool include_pending = 6; */
        if (message.includePending !== false)
            writer.tag(6, WireType.Varint).bool(message.includePending);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class ReserveDeviceRequest$Type extends MessageType<ReserveDeviceRequest> {
    constructor() {
        super("remote_control.home.ReserveDeviceRequest", [
            { no: 1, name: "model_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "model_version", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<ReserveDeviceRequest>): ReserveDeviceRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.modelId = "";
        message.modelVersion = "";
        if (value !== undefined)
            reflectionMergePartial<ReserveDeviceRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ReserveDeviceRequest): ReserveDeviceRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ReserveDeviceRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string model_id = 1; */
        if (message.modelId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.modelId);
        /* string model_version = 2; */
        if (message.modelVersion !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.modelVersion);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message remote_control.home.ReserveDeviceRequest
 */
export const ReserveDeviceRequest = new ReserveDeviceRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ReserveDeviceResponse$Type extends MessageType<ReserveDeviceResponse> {
    constructor() {
        super("remote_control.home.ReserveDeviceResponse", [
            { no: 1, name: "ok", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 2, name: "message", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "device_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<ReserveDeviceResponse>): ReserveDeviceResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.ok = false;
        message.message = "";
        message.deviceId = "";
        if (value !== undefined)
            reflectionMergePartial<ReserveDeviceResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ReserveDeviceResponse): ReserveDeviceResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ReserveDeviceResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool ok = 1; */
        if (message.ok !== false)
            writer.tag(1, WireType.Varint).bool(message.ok);
        /* string message = 2; */
...
/**
 * @generated MessageType for protobuf message remote_control.home.ReserveDeviceResponse
 */
export const ReserveDeviceResponse = new ReserveDeviceResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
export const HomeService = new ServiceType("remote_control.home.HomeService", [
    ...
    { name: "ReserveDevice", options: {}, I: ReserveDeviceRequest, O: ReserveDeviceResponse },
