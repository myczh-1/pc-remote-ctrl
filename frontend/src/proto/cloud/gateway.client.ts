...
// tslint:disable
import { AuditService } from "./gateway";
import type { CleanupLogsResponse } from "../home/service";
import type { CleanupAuditLogsRequest } from "./gateway";
import type { ListLogsResponse } from "../home/service";
import type { ListAuditLogsRequest } from "./gateway";
 ...
 *
 * @generated from protobuf service remote_control.cloud.v1.AuditService
 */
export interface IAuditServiceClient {
    /**
     * @generated from protobuf rpc: ListLogs
     */
    listLogs(input: ListAuditLogsRequest, options?: RpcOptions): UnaryCall<ListAuditLogsRequest, ListLogsResponse>;
    /**
     * @generated from protobuf rpc: CleanupLogs
     */
    cleanupLogs(input: CleanupAuditLogsRequest, options?: RpcOptions): UnaryCall<CleanupAuditLogsRequest, CleanupLogsResponse>;
}
/**
 * 审计日志：代理 HomeService.AuditService
 *
...
export class AuditServiceClient implements IAuditServiceClient, ServiceInfo {
    ...
    listLogs(input: ListAuditLogsRequest, options?: RpcOptions): UnaryCall<ListAuditLogsRequest, ListLogsResponse> {
        const method = this.methods[0], opt = this._transport.mergeOptions(options);
        return stackIntercept<ListAuditLogsRequest, ListLogsResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * @generated from protobuf rpc: CleanupLogs
     */
    cleanupLogs(input: CleanupAuditLogsRequest, options?: RpcOptions): UnaryCall<CleanupAuditLogsRequest, CleanupLogsResponse> {
        const method = this.methods[1], opt = this._transport.mergeOptions(options);
        return stackIntercept<CleanupAuditLogsRequest, CleanupLogsResponse>("unary", this._transport, method, opt, input);
    }
}
