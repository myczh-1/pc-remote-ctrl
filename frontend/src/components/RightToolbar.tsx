...
export function RightToolbar({ mode = 'local', showLogs = false, onToggleMode, onRefresh, onConfigCloud, onToggleLogs, onAdd }: RightToolbarProps) {
  ...
  return (
    <motion.aside
      className="hidden lg:flex fixed right-5 top-1/2 -translate-y-1/2 z-40 flex-col items-center gap-3 overflow-hidden px-2 py-3 bg-white/60 dark:bg-surface-soft/60 backdrop-blur-sm backdrop-saturate-[1.2] rounded-2xl border border-black/10 dark:border-white/10"
